...
Ron is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start Ron locally by running:
...
Then you can interact with Ron by typing `Ron help`.

    Ron> Ron help
    Ron animate me <query> - The same thing as `image me`, except adds [snip]
    Ron help - Displays all of the help commands that Ron knows about.
    ...
